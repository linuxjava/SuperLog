 ...
 * so if we setup a log level using <code>SuperLog.init(...)</code>, all the logs which is with
...
public class LogLevel {
  ...
  /**
   * Log level for SuperLog.v.
   */
  public static final int VERBOSE = 2;

  /**
   * Log level for SuperLog.d.
   */
  public static final int DEBUG = 3;

  /**
   * Log level for SuperLog.i.
   */
  public static final int INFO = 4;

  /**
   * Log level for SuperLog.w.
   */
  public static final int WARN = 5;

  /**
   * Log level for SuperLog.e.
   */
  public static final int ERROR = 6;

  /**
   * Log level for SuperLog#init, printing all logs.
   */
  public static final int ALL = Integer.MIN_VALUE;

  /**
   * Log level for SuperLog#init, printing no log.
   */
