...
package free.xiao.superlog.internal;

import android.content.Intent;
import android.os.Bundle;

import free.xiao.superlog.flattener.DefaultFlattener;
import free.xiao.superlog.flattener.Flattener;
import free.xiao.superlog.flattener.Flattener2;
import free.xiao.superlog.formatter.border.BorderFormatter;
import free.xiao.superlog.formatter.border.DefaultBorderFormatter;
import free.xiao.superlog.formatter.message.json.DefaultJsonFormatter;
import free.xiao.superlog.formatter.message.json.JsonFormatter;
import free.xiao.superlog.formatter.message.object.BundleFormatter;
import free.xiao.superlog.formatter.message.object.IntentFormatter;
import free.xiao.superlog.formatter.message.object.ObjectFormatter;
import free.xiao.superlog.formatter.message.throwable.DefaultThrowableFormatter;
import free.xiao.superlog.formatter.message.throwable.ThrowableFormatter;
import free.xiao.superlog.formatter.message.xml.DefaultXmlFormatter;
import free.xiao.superlog.formatter.message.xml.XmlFormatter;
import free.xiao.superlog.formatter.stacktrace.DefaultStackTraceFormatter;
import free.xiao.superlog.formatter.stacktrace.StackTraceFormatter;
import free.xiao.superlog.formatter.thread.DefaultThreadFormatter;
import free.xiao.superlog.formatter.thread.ThreadFormatter;
import free.xiao.superlog.printer.Printer;
import free.xiao.superlog.printer.file.FilePrinter;
import free.xiao.superlog.printer.file.backup.BackupStrategy;
import free.xiao.superlog.printer.file.backup.FileSizeBackupStrategy;
import free.xiao.superlog.printer.file.clean.CleanStrategy;
import free.xiao.superlog.printer.file.clean.NeverCleanStrategy;
import free.xiao.superlog.printer.file.naming.ChangelessFileNameGenerator;
import free.xiao.superlog.printer.file.naming.FileNameGenerator;
