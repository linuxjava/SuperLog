...
package free.xiao.superlog.printer.file;
...
import free.xiao.superlog.internal.util.FileUtil;
...
public class FilePrinter implements Printer {
    ...
    public static class Builder {
        ...
        private void fillEmptyFields() {
            ...
            //删除过期文件
            FileUtil.delOutDateFile(new File(folderPath), fileLogRetentionPeriod);
        }
    }
