...
import free.xiao.superlog.internal.DefaultsFactory;
...
public class LogConfiguration {
     ...
     * it can be a package name like "free.xiao.slog", a class name like "com.yourdomain.logWrapper",
    ...
    public static class Builder {
         ...
         *                         "free.xiao.slog", a class name like "com.yourdomain.logWrapper",
         *                         or something else between package name and class name, like "com.yourdomain.".
         *                         It is mostly used when you are using a logger wrapper
         * @param depth            the number of stack trace elements we should log, 0 if no limitation
         * @return the builder
